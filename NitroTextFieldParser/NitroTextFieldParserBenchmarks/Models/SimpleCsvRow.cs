...
public sealed class SimpleCsvRowPopulated
{
  public SimpleCsvRowPopulated()
  {
    
  }

  public SimpleCsvRowPopulated(IList<string> fieldValues)
  {
  ...
  public SimpleCsvRowPopulated(ReadOnlySpan<char> lineAsSpan)
  {
    FromCsv(lineAsSpan);
  }
  ...
  public void FromCsv(ReadOnlySpan<char> csvLine)
  {
    ;
